...
public class EmprestimoRepository : IEmprestimoRepository
{
    ...
    {
        return await _context.Emprestimos.Include(e => e.Livro).ThenInclude(l => l.Autores).ToListAsync();
    }

    public async Task<Emprestimo?> GetByIdAsync(int id)
    {
        return await _context.Emprestimos.Include(e => e.Livro).ThenInclude(l => l.Autores)
